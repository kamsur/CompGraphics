...
function Basic4_2(canvas) {
    ...
    let shearingX=ShearingX(-Math.tan(alpha/2));
    let triangle1 = new Triangle(ApplyLinearTransformation(shearingX, triangle.a),
    ...
    //			    corresponding parameters!
    //              Use ApplyLinearTransformation() to transform the corner points.
    let shearingY=ShearingY(Math.sin(alpha));
    let triangle2 = new Triangle(ApplyLinearTransformation(shearingY, triangle1.a),
    ...
    //			    corresponding parameters!
    //              Use ApplyLinearTransformation() to transform the corner points.
    let triangle3 = new Triangle(ApplyLinearTransformation(shearingX, triangle2.a),
